...
- сохраняем в таблицу app_requestresponse ссылку на текущий запрос, тем самым у нас получается, что есть хотябы одно предложение

- обновляем таблицу app_requestresponse для текущего запроса, после поиска всех возможных вариантов